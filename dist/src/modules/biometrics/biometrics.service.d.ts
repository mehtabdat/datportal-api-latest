...
export declare class BiometricsService {
    ...
    constructor(prisma: PrismaService, coordinatesService: CoordinatesService);
    create(createDto: CreateBiometricDto, user: AuthenticatedUser): Promise<{
        id: number;
        addedDate: Date;
        userId: number;
    ...
    findAll(filters: Prisma.BiometricsChecksWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        AddedBy: {
            id: number;
            phoneCode: string;
            status: number;
    ...
    findAllPublished(filters: Prisma.BiometricsChecksWhereInput, pagination: Pagination): Prisma.PrismaPromise<{
        id: number;
        addedDate: Date;
        userId: number;
        mode: import(".prisma/client").$Enums.BiometricsChecksType;
    ...
    update(id: number, updateDto: UpdateBiometricDto, user: AuthenticatedUser): Promise<{
        id: number;
        addedDate: Date;
        userId: number;
        mode: import(".prisma/client").$Enums.BiometricsChecksType;
    ...
    applyFilters(filters: BiometricsFilters): Prisma.BiometricsChecksWhereInput;
    countRecords(filters: Prisma.BiometricsChecksWhereInput): Prisma.PrismaPromise<number>;
    checkInCheckOut(createDto: CheckInCheckOutBiometricDto, user: AuthenticatedUser): Prisma.Prisma__BiometricsChecksClient<{
        id: number;
        addedDate: Date;
        userId: number;
        mode: import(".prisma/client").$Enums.BiometricsChecksType;
    ...
    validateCheckInCheckOut(createDto: CheckInCheckOutBiometricDto, user: AuthenticatedUser): Promise<void>;
    getTodayCheckInCheckOut(userId: number): Promise<{
        checkIn: BiometricsChecks;
        checkOut: BiometricsChecks;
    }>;
    delete(id: number): Prisma.Prisma__BiometricsChecksClient<{
        id: number;
        addedDate: Date;
        userId: number;
        mode: import(".prisma/client").$Enums.BiometricsChecksType;
