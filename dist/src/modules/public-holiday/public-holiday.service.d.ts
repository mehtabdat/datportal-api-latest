...
export declare class PublicHolidayService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    create(createDto: CreatePublicHolidayDto, user: AuthenticatedUser): Promise<Prisma.BatchPayload>;
    findAll(filters: Prisma.PublicHolidayWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        AddedBy: {
            id: number;
            phoneCode: string;
            status: number;
    ...
    update(id: number, updateDto: UpdatePublicHolidayDto): Promise<{
        id: number;
        title: string;
        date: Date;
        addedById: number;
    ...
    applyFilters(filters: PublicHolidayFilters): Prisma.PublicHolidayWhereInput;
    countRecords(filters: Prisma.PublicHolidayWhereInput): Prisma.PrismaPromise<number>;
