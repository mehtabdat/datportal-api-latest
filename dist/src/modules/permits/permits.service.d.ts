...
import { FileManagement, Permit, Prisma } from '@prisma/client';
...
export declare class PermitsService {
    ...
    create(createDto: CreatePermitDto): Promise<{
        id: number;
        clientId: number;
        projectId: number;
        authorityId: number;
    ...
    findAll(filters: Prisma.PermitWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
            Resources: number;
        };
        AddedBy: {
    ...
    update(id: number, updateDto: UpdatePermitDto): Promise<{
        Resources: {
            id: number;
            uuid: string;
            documentType: string;
    ...
    applyFilters(filters: PermitFiltersDto): Prisma.PermitWhereInput;
    handleDocuments(permit: Permit, files: Array<Express.Multer.File>, user: AuthenticatedUser): Promise<Prisma.BatchPayload>;
    markAllPermitAsSent(permit: Permit & {
        Resources: FileManagement[];
    }, user: AuthenticatedUser): Promise<void>;
    countRecords(filters: Prisma.PermitWhereInput): Prisma.PrismaPromise<number>;
}
