...
export declare class LeadsService {
    ...
    findAll(pagination: LeadsPaginationDto, sorting: LeadsSortingDto, condition: Prisma.LeadsWhereInput, includeNotes?: boolean): Prisma.PrismaPromise<({
        _count: {
    ...
    applyFilters(filters: LeadsFiltersDto, user: AuthenticatedUser, readAllLeads: boolean): Prisma.LeadsWhereInput;
    countTotalRecord(filters: Prisma.LeadsWhereInput): Prisma.PrismaPromise<number>;
    updateStatus(leadsId: number, leadsStatusDto: LeadsStatusDto): Promise<{
        id: number;
        uuid: string;
        message: string;
        status: number;
    ...
    assignLeads(leadsId: number, asignPropertyDto: AssignLeadsDto, user: AuthenticatedUser): Prisma.Prisma__LeadsClient<{
        id: number;
        uuid: string;
        message: string;
        status: number;
    ...
    addNote(leadId: number, createLeadNoteDto: CreateLeadNoteDto, user: AuthenticatedUser): Promise<{
        id: number;
        note: string;
        addedDate: Date;
        addedById: number;
    ...
    findAllNotes(leadId: number): Prisma.PrismaPromise<({
        AddedBy: {
            id: number;
            email: string;
            uuid: string;
    ...
    removeLead(leadId: number): Prisma.Prisma__LeadsClient<{
        id: number;
        uuid: string;
        message: string;
        status: number;
    ...
    handleDocuments(uploadDocuments: UploadLeadDocuments, files: Array<Express.Multer.File>, user: AuthenticatedUser): Promise<any[] | Prisma.BatchPayload>;
