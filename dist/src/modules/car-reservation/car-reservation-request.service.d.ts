...
export declare class CarReservationRequestService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    create(createDto: CreateCarReservationRequestDto, user: AuthenticatedUser): Promise<{
        id: number;
        requestById: number;
        projectId: number;
        companyCarId: number;
    ...
    findAll(filters: Prisma.CarReservationRequestWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
            AdminActions: number;
            Attachments: number;
        };
    ...
    hrUpdate(carReservationRequestId: number, carReservationRequestAdminAction: CarReservationRequestAdminAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    submitRequest(carReservationRequestId: number): Promise<{
        id: number;
        requestById: number;
        projectId: number;
        companyCarId: number;
    ...
    applyFilters(filters: CarReservationRequestFiltersDto, permissions?: Partial<CarReservationRequestPermissionSetType>): Prisma.CarReservationRequestWhereInput;
    countRecords(filters: Prisma.CarReservationRequestWhereInput): Prisma.PrismaPromise<number>;
    handleFiles(carReservationRequestId: number, files: Array<Express.Multer.File>): Promise<any[]>;
    checkAvailability(checkCarAvailabilityDto: CheckCarAvailabilityDto): Promise<boolean>;
}
