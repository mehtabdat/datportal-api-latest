...
const faqs_permissions_1 = require("./faqs.permissions");
const public_metadata_1 = require("../../authentication/public-metadata");
const faqs_pagination_dto_1 = require("./dto/faqs-pagination.dto");
const faqs_filter_dto_1 = require("./dto/faqs-filter.dto");
...
const multerOptions = (0, file_upload_utils_1.getMulterOptions)({ destination: (0, faqs_dto_1.getDynamicUploadPath)() });
const moduleName = "faqs";
let FaqsController = class FaqsController {
    constructor(faqsService) {
        this.faqsService = faqsService;
    }
    async uploadFaqImages(uploadFaqImage, files, req) {
        try {
    ...
    async getFaqsImages(params, req) {
        try {
    ...
    async update(params, updateFaqDto) {
        try {
...
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.UPDATE),
    (0, swagger_1.ApiConsumes)('multipart/form-data'),
    (0, swagger_1.ApiOperation)({ summary: `Upload Faqs images` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the uploaded images on success` }),
    ...
    __metadata("design:paramtypes", [upload_image_dto_1.UploadFaqImage,
        Array, Object]),
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "uploadFaqImages", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.CREATE),
    (0, swagger_1.ApiOperation)({ summary: `Add a new ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the new ${moduleName} record on success` }),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseArray, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)('find-published'),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [faqs_filter_dto_1.FaqsFiltersDto,
        faqs_pagination_dto_1.FaqsPaginationDto]),
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "findPublished", null);
__decorate([
    (0, public_metadata_1.Public)(),
    (0, swagger_1.ApiOperation)({ summary: `Fetch all ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)('find-by-slug/:slug'),
    __param(0, (0, common_1.Param)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [params_dto_1.FindBySlugDto]),
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "findBySlug", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.READ),
    (0, swagger_1.ApiOperation)({ summary: `Fetch all ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseArray, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
...
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.UPDATE),
    (0, swagger_1.ApiOperation)({ summary: `Delete Faqs images` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the deleted Faqs image object if found on the system` }),
    ...
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "removeImages", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.READ),
    (0, swagger_1.ApiOperation)({ summary: `Get Faqs Images` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the Faqs image` }),
    (0, common_1.Get)('getFaqsImages/:id'),
    __param(0, (0, common_1.Param)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [params_dto_1.ParamsDto, Object]),
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "getFaqsImages", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.READ),
    (0, swagger_1.ApiOperation)({ summary: `Fetch ${moduleName}  by id` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the ${moduleName} object if found on the system` }),
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the updated ${moduleName} object if found on the system` }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [params_dto_1.ParamsDto,
        update_faq_dto_1.UpdateFaqDto]),
    __metadata("design:returntype", Promise)
], FaqsController.prototype, "update", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(faqs_permissions_1.FaqsPermissionSet.DELETE),
    (0, swagger_1.ApiOperation)({ summary: `Delete ${moduleName}` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: faqs_dto_1.FaqsResponseObject, isArray: false, description: `Returns the deleted ${moduleName} object if found on the system` }),
