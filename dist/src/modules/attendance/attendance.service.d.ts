...
import { AttendanceStatus } from 'src/config/constants';
...
export declare class AttendanceService {
    ...
    constructor(prisma: PrismaService, attendanceQueue: Queue, excelService: ExcelService);
    checkAttendanceStatus(date: Date, hours: number, workingHour: WorkingHours): AttendanceStatus;
    calculateIncompleteDeduction(status: AttendanceStatus, date: Date, hours: number, workingHour: WorkingHours): number;
    create(createDto: CreateAttendanceDto, user: AuthenticatedUser): Promise<{
        id: number;
        userId: number;
        checkIn: Date;
        checkOut: Date;
    ...
    findAll(filters: Prisma.AttendanceWhereInput, pagination: Pagination, sorting: AttendanceSortingDto): Prisma.PrismaPromise<({
        AddedBy: {
            id: number;
            phoneCode: string;
            status: number;
    ...
    findPublicHolidays(filters: Prisma.PublicHolidayWhereInput): Prisma.PrismaPromise<{
        id: number;
        title: string;
        date: Date;
        addedById: number;
    ...
    findApprovedLeaveRequest(filters: Prisma.LeaveRequestWhereInput): Prisma.PrismaPromise<{
        id: number;
        requestById: number;
        leaveFrom: Date;
        leaveTo: Date;
    ...
    update(id: number, updateDto: UpdateAttendanceDto, user: AuthenticatedUser): Promise<{
        id: number;
        userId: number;
        checkIn: Date;
        checkOut: Date;
    ...
    applyFiltersPublicHolidays(filters: AttendanceFilters | UserAttendanceFilters): Prisma.PublicHolidayWhereInput;
    leaveRequestFilters(filters: AttendanceFilters | UserAttendanceFilters): Prisma.LeaveRequestWhereInput;
    applyFilters(filters: AttendanceFilters | UserAttendanceFilters): Prisma.AttendanceWhereInput;
    countRecords(filters: Prisma.AttendanceWhereInput): Prisma.PrismaPromise<number>;
    prepareAttendance(attendance: Array<Attendance & {
        AddedBy: Partial<User>;
        ModifiedBy?: Partial<User>;
        LeaveRequest?: LeaveRequest;
    }>, publicHolidays: PublicHoliday[], filters: UserAttendanceFilters, workingHour: WorkingHours): UserAttendanceType[];
    prepareAttendanceFromD1ToD2(attendance: Array<Attendance & {
        AddedBy: Partial<User>;
        ModifiedBy?: Partial<User>;
        LeaveRequest?: LeaveRequest;
    }>, publicHolidays: PublicHoliday[], filters: AttendanceFilters, workingHour: WorkingHours): UserAttendanceType[];
    ...
    triggerBulkAttendanceCalculation(): void;
    findOrganization(organizationId: number): Prisma.Prisma__OrganizationClient<{
        WorkingHours: {
            id: number;
            title: string;
    ...
    generateReport(reportDto: GenerateAttendanceReport): Promise<{
        fileName: string;
        filePath: string;
    }>;
    remove(id: number): Prisma.Prisma__AttendanceClient<{
        id: number;
        userId: number;
        checkIn: Date;
        checkOut: Date;
