...
export declare class CashAdvanceService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    create(createDto: CreateCashAdvanceDto, user: AuthenticatedUser): Promise<{
        id: number;
        requestById: number;
    ...
    findAll(filters: Prisma.CashAdvanceRequestWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
            AdminActions: number;
            Attachments: number;
        };
    ...
    hrUpdate(cashAdvanceRequestId: number, cashAdvanceHrAction: CashAdvanceHrAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    financeUpdate(cashAdvanceRequestId: number, cashAdvanceFinanceAction: CashAdvanceFinanceAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    applyFilters(filters: CashAdvanceRequestFiltersDto, permissions?: Partial<CashAdvancePermissionSetType>): Prisma.CashAdvanceRequestWhereInput;
    countRecords(filters: Prisma.CashAdvanceRequestWhereInput): Prisma.PrismaPromise<number>;
    handleFiles(cashAdvanceRequestId: number, files: Array<Express.Multer.File>): Promise<any[]>;
    markAsPaid(installmentPaidDto: InstallmentPaidDto): Promise<{
        id: number;
        cashAdvanceRequestId: number;
        amount: number;
        isPaid: boolean;
