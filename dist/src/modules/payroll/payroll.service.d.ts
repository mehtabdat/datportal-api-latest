...
export declare class PayrollService {
    ...
    constructor(prisma: PrismaService, payrollQueue: Queue, attendanceService: AttendanceService, payrollProcessorService: PayrollProcessorService, excelService: ExcelService);
    findAll(filters: Prisma.PayrollWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        ModifiedBy: {
            id: number;
            phoneCode: string;
            status: number;
    ...
    update(id: number, updateDto: UpdatePayrollDto, user: AuthenticatedUser): Promise<{
        id: number;
        monthYear: Date;
        userId: number;
        totalLates: number;
    ...
    applyFilters(filters: PayrollFiltersDto): Prisma.PayrollWhereInput;
    countRecords(filters: Prisma.PayrollWhereInput): Prisma.PrismaPromise<number>;
    remove(recordId: number): Promise<{
        Deductions: {
            id: number;
            payrollId: number;
            installmentId: number;
    ...
    recalculate(recordId: number): Promise<{
        Salary: {
            id: number;
            userId: number;
            amount: number;
    ...
    markAsPaid(paidPayrollsDto: PaidPayrollsDto, user: AuthenticatedUser): Prisma.PrismaPromise<Prisma.BatchPayload>;
    generateReport(reportDto: GeneratePayrollReport): Promise<{
        fileName: string;
        filePath: string;
    }>;
}
