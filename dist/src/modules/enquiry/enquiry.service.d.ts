...
export declare class EnquiryService {
    ...
    create(createDto: CreateEnquiryDto): Promise<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    findAll(pagination: Pagination, condition: Prisma.EnquiryWhereInput): Prisma.PrismaPromise<({
        _count: {
    ...
    findDuplicateClient(id: number): Promise<{
        id: number;
        name: string;
        phoneCode: string;
        email: string;
    ...
    update(id: number, updateDto: UpdateEnquiryDto): Promise<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    applyFilters(filters: EnquiryFiltersDto, user: AuthenticatedUser, readAllEnquiry: boolean): Prisma.EnquiryWhereInput;
    countTotalRecord(filters: Prisma.EnquiryWhereInput): Prisma.PrismaPromise<number>;
    updateStatus(enquiryId: number, enquiryStatusDto: EnquiryStatusDto): Promise<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    checkIfAlreadyRequested(createEnquiryDto: CreateEnquiryDto): Prisma.Prisma__EnquiryClient<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    markAsReplied(enquiryData: Enquiry): Prisma.Prisma__EnquiryClient<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    addNote(enquiryId: number, createNote: CreateEnquiryNoteDto, user: AuthenticatedUser): Promise<{
        id: number;
        note: string;
        addedDate: Date;
        addedById: number;
    ...
    removeNote(noteId: number): Prisma.Prisma__LeadEnquiryFollowUpClient<{
        id: number;
        note: string;
        addedDate: Date;
        addedById: number;
    ...
    removeDocument(documentId: number): Prisma.Prisma__EnquiryAttachmentClient<{
        id: number;
        title: string;
        file: string;
        mimeType: string;
    ...
    findAllNotes(noteId: number): Prisma.PrismaPromise<({
        AddedBy: {
            id: number;
            email: string;
            uuid: string;
    ...
    assignEnquiry(enquiryId: number, asignPropertyDto: AssignEnquiryDto, user: AuthenticatedUser): Prisma.Prisma__EnquiryClient<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    removeEnquiry(enquiryId: number): Prisma.Prisma__EnquiryClient<{
        id: number;
        uuid: string;
        name: string;
        slug: string;
    ...
    autoCreateLeadUsingEnquiry(createLeadDto: AutoCreateLeadFromEnquiryDto, user: AuthenticatedUser): Promise<{
        id: number;
        uuid: string;
        message: string;
        status: number;
    ...
    upsertClient(enquiryData: Enquiry, clientType: ClientType, parentId?: number): Promise<{
        id: number;
        uuid: string;
        name: string;
        type: number;
    ...
    handleDocuments(enquiryDocuments: UploadEnquiryDocuments, files: Array<Express.Multer.File>, user: AuthenticatedUser): Promise<any[] | Prisma.BatchPayload>;
    markConcernAsResolved(noteId: number): Prisma.Prisma__LeadEnquiryFollowUpClient<{
        id: number;
        note: string;
        addedDate: Date;
        addedById: number;
