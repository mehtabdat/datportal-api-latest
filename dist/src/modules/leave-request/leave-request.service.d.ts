...
export declare class LeaveRequestService {
    ...
    create(createDto: CreateLeaveRequestDto, user: AuthenticatedUser): Promise<{
        id: number;
        requestById: number;
        leaveFrom: Date;
        leaveTo: Date;
    ...
    findAll(filters: Prisma.LeaveRequestWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
            AdminActions: number;
            Attachments: number;
        };
        ...
        AdminActions: ({
            Department: {
                ...
                Notification: {
                    ...
                    mode: import(".prisma/client").$Enums.NotificationMode;
                    linkLabel: string;
                }[];
            };
            ActionBy: {
    ...
    projectManagerAction(leaveRequestId: number, leaveRequestAdminAction: LeaveRequestAdminAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    hrUpdate(leaveRequestId: number, leaveRequestAdminAction: LeaveRequestAdminAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    submitRequest(leaveRequestId: number): Promise<{
        id: number;
        requestById: number;
        leaveFrom: Date;
        leaveTo: Date;
    ...
    applyFilters(filters: LeaveRequestFiltersDto, user: AuthenticatedUser, permissions?: Partial<LeaveRequestPermissionSetType>): Prisma.LeaveRequestWhereInput;
    countRecords(filters: Prisma.LeaveRequestWhereInput): Prisma.PrismaPromise<number>;
    handleFiles(leaveRequestId: number, files: Array<Express.Multer.File>): Promise<any[]>;
    getLeaveInfo(leaveRequestInfoDto: LeaveRequestInfoDto, user: AuthenticatedUser): Promise<void>;
    findLeavesReport(userId: number): Promise<{
        paidLeaves: number;
        unpaidLeaves: number;
