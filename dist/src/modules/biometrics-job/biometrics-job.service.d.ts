...
export declare class BiometricsJobService {
    private prisma;
    private propertyQueue;
    private readonly logger;
    constructor(prisma: PrismaService, propertyQueue: Queue);
    create(createDto: CreateBiometricsJobDto): Promise<{
        id: number;
        file: string;
        status: number;
        isDeleted: boolean;
    ...
    findAll(filters: Prisma.BiometricsJobWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
    ...
    update(id: number, updateDto: UpdateBiometricsJobDto): Promise<{
        id: number;
        file: string;
        status: number;
        isDeleted: boolean;
    ...
    applyFilters(filters: BiometricsJobFilters): Prisma.BiometricsJobWhereInput;
    countRecords(filters: Prisma.BiometricsJobWhereInput): Prisma.PrismaPromise<number>;
    remove(jobId: number): Promise<{
        id: number;
        file: string;
        status: number;
        isDeleted: boolean;
    ...
    rollback(jobId: number, biometricsJobRollbackDto: BiometricsJobRollbackDto): Promise<{
        _count: {
            BiometricsChecks: number;
        };
        AddedBy: {
    ...
    setIsProcessing(id: number): Prisma.Prisma__BiometricsJobClient<{
        id: number;
        file: string;
        status: number;
        isDeleted: boolean;
    ...
    bulkUploadBiometrics(jobId: number): Promise<{
        id: number;
        file: string;
        status: number;
        isDeleted: boolean;
    ...
    stopUploadBiometrics(jobId: number): Promise<{
        message: string;
    }>;
}
