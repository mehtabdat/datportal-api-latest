...
export declare class CompanyAssetService {
    private prisma;
    private readonly logger;
    constructor(prisma: PrismaService);
    create(createDto: CreateCompanyAssetDto): Promise<{
        id: number;
        code: string;
        type: number;
        assetName: string;
    ...
    allocateResource(createDto: AllocateAssetToUserDto): Prisma.Prisma__AssetAllocationClient<{
        id: number;
        userId: number;
        quantity: number;
        addedDate: Date;
    ...
    findAll(filters: Prisma.CompanyAssetWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        AssetAllocation: ({
            User: {
                id: number;
                phoneCode: string;
    ...
    findCompanyCars(): Prisma.PrismaPromise<{
        id: number;
        code: string;
        type: number;
        assetName: string;
    ...
    findAllPublished(filters: Prisma.CompanyAssetWhereInput, pagination: Pagination): Prisma.PrismaPromise<{
        id: number;
        code: string;
        type: number;
        assetName: string;
    ...
    update(id: number, updateDto: UpdateCompanyAssetDto): Promise<{
        id: number;
        code: string;
        type: number;
        assetName: string;
    ...
    applyFilters(filters: CompanyAssetFiltersDto): Prisma.CompanyAssetWhereInput;
    countRecords(filters: Prisma.CompanyAssetWhereInput): Prisma.PrismaPromise<number>;
}
