...
export declare class ReimbursementService {
    ...
    create(createDto: CreateReimbursementDto, user: AuthenticatedUser): Promise<{
        id: number;
        requestById: number;
    ...
    findAll(filters: Prisma.ReimbursementWhereInput, pagination: Pagination): Prisma.PrismaPromise<({
        _count: {
            AdminActions: number;
    ...
    hrUpdate(reimbursementId: number, reimbursementHrAction: ReimbursementHrAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            Department: {
                id: number;
                isPublished: boolean;
    ...
    financeUpdate(reimbursementId: number, reimbursementAction: ReimbursementFinanceAction, user: AuthenticatedUser): Promise<{
        AdminActions: ({
            ActionBy: {
                id: number;
                phoneCode: string;
    ...
    applyFilters(filters: ReimbursementFiltersDto, permissions?: Partial<ReimbursementPermissionSetType>): Prisma.ReimbursementWhereInput;
    countRecords(filters: Prisma.ReimbursementWhereInput): Prisma.PrismaPromise<number>;
    handleFiles(reimbursementId: number, reimbursementReceipts: ReimbursementReceipts[], files: Array<Express.Multer.File>, user: AuthenticatedUser): Promise<any[]>;
}
