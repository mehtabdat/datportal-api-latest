...
const department_permissions_1 = require("./department.permissions");
const department_filters_dto_1 = require("./dto/department-filters.dto");
...
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(department_permissions_1.DepartmentPermissionSet.CREATE),
    (0, swagger_1.ApiOperation)({ summary: `Add a new ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseObject, isArray: false, description: `Returns the new ${moduleName} record on success` }),
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseArray, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)('find-published'),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [department_filters_dto_1.DepartmentFiltersDto,
        common_types_1.Pagination]),
    __metadata("design:returntype", Promise)
], DepartmentController.prototype, "findPublished", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: `Fetch all ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseObject, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)('find-by-slug/:slug'),
    __param(0, (0, common_1.Param)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [common_types_1.FindBySlugDto]),
    __metadata("design:returntype", Promise)
], DepartmentController.prototype, "findBySlug", null);
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(department_permissions_1.DepartmentPermissionSet.READ),
    (0, swagger_1.ApiOperation)({ summary: `Fetch all ${moduleName} in the system` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseArray, isArray: false, description: `Return a list of ${moduleName} available` }),
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)()),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseObject, isArray: false, description: `Returns the ${moduleName} object if found on the system` }),
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(department_permissions_1.DepartmentPermissionSet.UPDATE),
    ...
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseObject, isArray: false, description: `Returns the updated ${moduleName} object if found on the system` }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)()),
...
__decorate([
    (0, authorization_decorator_1.CheckPermissions)(department_permissions_1.DepartmentPermissionSet.DELETE),
    (0, swagger_1.ApiOperation)({ summary: `Delete ${moduleName}` }),
    (0, swagger_1.ApiResponse)({ status: 200, type: department_dto_1.DepartmentResponseObject, isArray: false, description: `Returns the deleted ${moduleName} object if found on the system` }),
