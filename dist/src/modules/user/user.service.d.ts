...
import { userAttributesTypes } from './dto/user.dto';
...
export declare class UserService {
    ...
    findAllocatedResource(id: number): Prisma.PrismaPromise<({
        CompanyAsset: {
            id: number;
            type: number;
            code: string;
    ...
    findOneByEmail(email: string, atttibutes?: userAttributesTypes): Promise<{
        id: number;
        phoneCode: string;
        status: number;
        isPublished: boolean;
    ...
    findLoggedInUserDetails(email: string, extraParams?: Prisma.UserSelect): Promise<{
        id: number;
        phoneCode: string;
        status: number;
        Organization: {
    ...
    addUserRole(id: number, roles: Array<number>): Promise<Prisma.BatchPayload>;
    removeAllUserRoles(id: number): Prisma.PrismaPromise<Prisma.BatchPayload>;
    findUserRolesByRoleIds(userId: number, roleIds: number[]): Prisma.PrismaPromise<{
        id: number;
        userId: number;
        roleId: number;
    }[]>;
    removeUserRolesByRoleIds(userId: number, roleIds: number[]): Prisma.PrismaPromise<Prisma.BatchPayload>;
    findLoggedInUserMenu(user: AuthenticatedUser): any;
    findUserPermissionsAgainstSlugs(user: AuthenticatedUser, slugs: string | string[]): Promise<{}>;
    applyFilters(filters: UserFiltersDto): Prisma.UserWhereInput;
    applyFiltersAuthTokensIssued(filters: UserAuthTokensIssuedDto): Prisma.AuthTokensWhereInput;
    countTotalRecord(filters: Prisma.UserWhereInput): Prisma.PrismaPromise<number>;
    countTotalAuthToken(filters: Prisma.AuthTokensWhereInput): Prisma.PrismaPromise<number>;
    createUserAvatar(userId: number, meta?: {
        username: string;
        shouldFetch: boolean;
    }): Promise<string | false>;
    updateUserMeta(userId: number, updateUserMetaDto: UpdateUserMetaDto): Promise<any[]>;
    deleteUserMeta(metaId: number): Promise<{
        id: number;
        key: string;
        value: string;
        userId: number;
    }>;
    deleteUserMetaByKey(userId: number, key: keyof typeof UserMetaKeys): Promise<{
        id: number;
        key: string;
        value: string;
        userId: number;
    ...
    deactivateUser(userId: number): Prisma.Prisma__UserClient<{
        id: number;
        uuid: string;
        firstName: string;
        lastName: string;
    ...
    handleUserDocuments(userDocuments: UploadUserDocuments, files: Array<Express.Multer.File>, user: AuthenticatedUser): Promise<any[] | Prisma.BatchPayload>;
    updateUserDocument(updateDocuments: UpdateUserDocuments): Prisma.Prisma__UserDocumentClient<{
        id: number;
        title: string;
        file: string;
        documentType: string;
    ...
    deleteUserDocument(documentId: number): Prisma.Prisma__UserDocumentClient<{
        id: number;
        title: string;
        file: string;
        documentType: string;
    ...
    findDashboardElements(user: AuthenticatedUser): Promise<{
        roleId: number;
        dashboardElementId: number;
        order: number;
    }[]>;
    updateSalary(userId: number, userSalaryDto: UserSalaryDto): Promise<{
        id: number;
        userId: number;
        amount: number;
        startDate: Date;
