...
var ProjectStateService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ProjectStateService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma.service");
let ProjectStateService = ProjectStateService_1 = class ProjectStateService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(ProjectStateService_1.name);
    }
    create(createDto) {
    ...
    findAllPublishedStates(filters) {
        return this.prisma.projectState.findMany({
            where: filters,
            orderBy: {
                id: 'desc'
...
ProjectStateService = ProjectStateService_1 = __decorate([
