...
import { Client, Organization, Prisma, Project, ProjectMembers, ProjectState } from '@prisma/client';
export declare class NotificationProcessorService {
    private prisma;
    private readonly mailService;
    private readonly logger;
    activeJob: NotificationEventDto;
    jobQueue: Array<NotificationEventDto>;
    isProcessing: boolean;
    constructor(prisma: PrismaService, mailService: MailService);
    sendNotification(eventData: NotificationEventDto): Promise<void>;
    handleNext(): void;
    sendInvoiceNotification(recordId: number): Promise<void>;
    sendProjectHoldNotification(recordId: number): Promise<void>;
    sendProjectResumeNotification(recordId: number): Promise<void>;
    sendReimbursementNotification(recordId: number): Promise<void>;
    sendNewProjectNotification(recordId: number): Promise<void>;
    sendProjectMembersChangeNotification(recordId: number, additionalData: any): Promise<void>;
    sendEachProjectMembersChangeNotification(recordData: Partial<Project> & {
        ProjectState: Partial<ProjectState>;
        Client: Partial<Client>;
        SubmissionBy: Partial<Organization>;
    }, addedMember: ProjectMembers): Promise<void>;
    getQuotation(recordId: number): Prisma.Prisma__QuotationClient<{
        Lead: {
            Client: {
                id: number;
                uuid: string;
    ...
    getFinanceUsers(): Prisma.PrismaPromise<{
        id: number;
        phoneCode: string;
        status: number;
        isPublished: boolean;
    ...
    sendQuotationNotification(recordId: number): Promise<void>;
    sendMilestoneCompletedNotification(recordId: number): Promise<void>;
    sendEnquiryConfirmedNotification(leadId: number): Promise<void>;
    findUsersBasedOnPermission(permission: string | string[], emailSubscribers?: boolean, condition?: Prisma.UserWhereInput): Promise<{
        id: number;
        phoneCode: string;
        status: number;
        isPublished: boolean;
    ...
    findProjectUsers(projectId: number, emailSubscribers?: boolean): Promise<{
        id: number;
        phoneCode: string;
        status: number;
        isPublished: boolean;
    ...
    sendAssignedQuotationFollowupNotification(): Promise<void>;
    sendQuotationFollowupNotification(): Promise<void>;
    sendInvoiceFollowupNotification(): Promise<void>;
    sendLeadsFollowupNotification(): Promise<void>;
    sendGovernmentFeesToCollectNotification(): Promise<void>;
}
