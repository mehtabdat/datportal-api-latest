...
export declare class NotificationService {
    ...
    findAll(condition: Prisma.NotificationWhereInput, pagination: NotificationPaginationDto): Prisma.PrismaPromise<{
        id: number;
        slug: string;
        icon: string;
        message: string;
    ...
    findAllAnnouncement(condition: Prisma.NotificationWhereInput, pagination: NotificationPaginationDto): Prisma.PrismaPromise<({
        Department: {
            id: number;
            isPublished: boolean;
            isDeleted: boolean;
    ...
    readNotification(id: number, user: AuthenticatedUser): Promise<{
        userId: number;
        notificationId: number;
        modifiedDate: Date;
        read: boolean;
    }>;
    readAllNotification(user: AuthenticatedUser): Promise<boolean>;
    applyFilters(filters: NotificationFilters, user: AuthenticatedUser): Prisma.NotificationWhereInput;
    applyAnnouncementFilters(): Prisma.NotificationWhereInput;
    countNotifications(filters: Prisma.NotificationWhereInput): Prisma.PrismaPromise<number>;
}
